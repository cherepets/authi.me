...
namespace Authi.App.Test.Mocks
{
    internal class MockSettings : ISettings
    {
        ...
        public IAsyncValueSetting<bool> IsBiometricsEnabled { get; } = new MockAsyncValueSetting<bool>();
        public IAsyncValueSetting<bool> IsHideCodesEnabled { get; } = new MockAsyncValueSetting<bool>();
